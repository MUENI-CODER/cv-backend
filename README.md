README.md
# 📄 CV Management System - Full Stack Application
...
- Modern, Professional, Creative, Executive, Minimal, Tech, Elegant, Compact
- Live preview while editing
- Color-coded templates

### 🔗 **Shareable CV Links**
- Each CV gets a unique URL
...
```bash
git clone https://github.com/MUENI-CODER/cv-backend.git
cd cv-backend
npm install
